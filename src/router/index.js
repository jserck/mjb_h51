...
const Housetype = function(resolve) {
    require.ensure([], function() {
        resolve(require("@/components/housetype/housetypes"));
    });
};
//楼盘评测分享
...
//楼盘评分雷达图
const EchartRouting = function(resolve) {
    require.ensure([], function() {
        resolve(require("@/components/obshare/echartRouting"))
    }, 'Houseeval')
}
const Ereter = function(resolve) {
    require.ensure([], function() {
        resolve(require('@/components/ereter/ereter'));
    });
}
//质量寻光计划黑匣子
const QualityFind = function(resolve) {
    require.ensure([], function() {
        resolve(require('@/components/qualityFind/qualityFind'));
    });
}
//开启购房之旅
const StartBuyingAHome = function(resolve) {
    require.ensure([], function() {
        resolve(require('@/components/startBuyingAHome/startBuyingAHome'));
    });
}
const ClickMe = function(resolve) {
    require.ensure([], function() {
        resolve(require('@/components/clickMe/clickMe'));
    });
}
const InviteFriend = function(resolve) {
    require.ensure([], function() {
        resolve(require('@/components/inviteFriend/inviteFriend'));
    });
}
const GetInviteFriend = function(resolve) {
    require.ensure([], function() {
        resolve(require('@/components/getInviteFriend/getInviteFriend'));
    });
}
//引流邀请
const Drainage = function(resolve) {
    require.ensure([], function() {
        resolve(require('@/components/drainage/drainage'));
    });
}
//引流被邀请
const Bydrainage = function(resolve) {
    require.ensure([], function() {
        resolve(require('@/components/drainage/by_drainage'));
    });
}
//全景详情
const Panorama = function(resolve) {
    require.ensure([], function() {
        resolve(require("@/components/panorama/panorama"));
    });
}
//楼按资讯查询
const Housequery = function(resolve) {
    require.ensure([], function() {
        resolve(require('@/components/housequery/housequery'));
    });
}
//楼盘资讯查询结果页
const HouseQueryOver = function(resolve) {
    require.ensure([], function() {
        resolve(require('@/components/housequery/houseQueryOver'));
    });
}
//楼盘资讯查询详情页
const HouseQueryDetails = function(resolve) {
    require.ensure([], function() {
        resolve(require('@/components/housequery/houseQueryDetails'));
    });
}
//拍照 APP 用户协议
const PhotoAdminText = function(resolve) {
    require.ensure([], function() {
        resolve(require('@/components/photoAdminText/photoAdminText'));
    });
}
...
export default new Router({
    ...
    routes: [
        ...
        //严选楼盘分享
        {
            ...
            name: "obshare",
            component: () => import('@/components/obshare/obshare')
        },
        //优惠咨询
        {
            path: '/information/:id',
        ...
        //户型详情
        {
            path: '/housetype/:id/:arid/:platform',
            name: 'housetype',
            component: () => import('@/components/houseType/housetypes')
        },
        // //资讯版本更新
        // {
        //           path: "/analyze/:id",
        ...
        //楼盘评测分享
        {
            path: "/echartRouting/:id",
            name: "echartRouting",
            component: EchartRouting
        },
        //鹰眼评分体系
        {
            path: '/ereter',
        ...
        //质量寻光计划黑匣子
        {
            path: '/qualityFind',
            name: 'QualityFind',
            component: QualityFind
        },
        //开启购房之旅
        {
            path: '/startBuyingAHome',
            name: 'startBuyingAHome',
            component: StartBuyingAHome
        },
        //点我
        {
            path: '/clickMe',
        ...
        //接收好友分享
        {
            path: '/getInviteFriend',
            name: 'getInviteFriend',
            component: GetInviteFriend
        },
        //引流邀请
        {
            path: '/drainage',
        ...
        //楼盘资讯查询结果页
        {
            path: '/houseQueryOver',
            name: "houseQueryOver",
            component: HouseQueryOver
        },
        //楼盘资讯查询详情页
        {
            path: '/houseQueryDetails',
            name: "houseQueryDetails",
            component: HouseQueryDetails
        },
        //楼盘资讯查询详情页
        {
            path: '/photoAdminText',
            name: "photoAdminText",
            component: PhotoAdminText
        },
    ]
});
