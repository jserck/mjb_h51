<template>
     <div class="animateInputOver">
          ...
          <div id="test-target1" class="g-ine">
               ...
               <div class="g-code">
                    <img
                         src="http://app1.homehawkeye.com/F25073AE-2F65-4cec-A31F-55FF58522057.png"
                         alt
                    />
               </div>
          </div>
          <div class="g-btn" @click="appDowns">
               <img
                    style="width: 100%;"
                    src="http://app1.homehawkeye.com/%E7%82%B9%E5%87%BB%E4%B8%8B%E8%BD%BD%E6%8C%89%E9%92%AE.png"
                    alt
               />
          </div>
          <!--<div id="result">-->
...
export default {
     data() {
          return {
               imgArr: [
                    'http://app1.homehawkeye.com/gff.png',
                    'http://app1.homehawkeye.com/%E9%92%A2%E9%93%81.png',
                    'http://app1.homehawkeye.com/%E7%BE%8E%E9%98%9F.png',
                    'http://app1.homehawkeye.com/%E9%94%A4%E5%AD%90.png',
                    'http://app1.homehawkeye.com/%E8%9C%98%E8%9B%9B%E4%BE%A0.png'
               ],
               ids: 'test-target1',
               codeImg: '',
               zi: false,
