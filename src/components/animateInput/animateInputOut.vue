<template>
     <div class="animateInputOut">
          ...
          <div class="g-bg">
               <img src="http://app1.homehawkeye.com/tuanbg.png" alt="">
          </div>
          <div class="g-tit">
...
export default {
     ...
     methods: {
          ...
          preImg() {
               ...
               img.src = 'http://app1.homehawkeye.com/xiugai-xianzekuang.png';
...
.g-bg-big {
      ...
      width: 100%;
      height: 100%;
      background-image: url("http://app1.homehawkeye.com/bg.png");
      z-index: 0;
}
...
.g-tit {
      ...
      width: 6.3rem;
      height: 3.74rem;
      background-image: url("http://app1.homehawkeye.com/chuanghu.png");
...
.g-check {
      ...
      width: 5.85rem;
      height: 1.95rem;
      background: url("http://app1.homehawkeye.com/xiugai-weixuanze.png");
      background-size: cover;
}
...
.g-checks {
      ...
      width: 5.85rem;
      height: 1.95rem;
      background: url("http://app1.homehawkeye.com/xiugai-xianzekuang.png");
      background-size: cover;
}
