<template>
     <div class="animateInputLogin">
          <div class="g-bg-big">
               ...
               <div class="g-form">
                    <div class="g-form-bg">
                         <img src="http://app1.homehawkeye.com/xxtx.png" alt="">
                    </div>
                    ...
                    <div class="g-btn" @click="submit">
                         <img style="width: 100%;" src="http://app1.homehawkeye.com/%E7%94%9F%E6%88%90%E7%BB%93%E6%9E%9C%E6%8C%89%E9%92%AE.png" alt="">
                    </div>
...
export default {
     ...
     methods: {
          ...
          preImg() {
               ...
               img.src = 'http://app1.homehawkeye.com/xxtx.png';
