<template>
     <div class="houseeval">
          <div class="g-houseeval-header">
               ...
               <Leber :data="data.maijiab.labels"/>
          ...
          <div :class="houseeval" ref="houseevals">
               ...
               <div class="g-crreltion-house" v-if=" !$route.query.type">
                    <h1>相关楼盘</h1>
                    <div
                         class="u-crreltion-house-message displayFlex flexJustifybetween"
                         v-for="(item,index) in data.propertyList"
                         :key="index"
                         @click="f_pathHandler(item.propertyId)"
                    >
                         <div
                              class="u-crreltion-house-message-img"
                         ...
                         <div class="u-crreltion-house-message-text">
                              ...
                              <div
                                   class="u-crreltion-house-message-text-2 displayFlex"
                                   v-if="item.buildingState == 1"
                              >
               ...
               <div class="unfold-field" v-if="isfiled">
                    ...
                    <div class="unfold-field_text" @click="f_see_all">
                         <span v-if="!token_">下载鹰眼鉴房查看全文</span>
...
import Leber from "@/components/common/icon";
export default {
     data() {
          return {
               downLoadUrl: "https://test.homehawkeye.com/appDown.html",
               isfiled: false,
