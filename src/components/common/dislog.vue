<template>
     <div class="g-dislog">
          <transition name="el-fade-in-linear">
               <div
                    class="transition-box sur_moban_"
                    v-show="show"
                    @touchmove.prevent
                    @click="close"
               ></div>
     ...
     methods: {
          f_appShare() {
               let options = {
                    ...
                    azData: 'http://192.168.1.247:8080/#/testOver?data=%7B%22count1%22%3A3,%22count2%22%3A4,%22count3%22%3A0,%22count4%22%3A0,%22count5%22%3A0,%22count6%22%3A0,%22createTime%22%3A%222018-05-30%2009%3A48%3A05%22,%22totalScore%22%3A85%7D&time=2018-05-30%2009%3A48%3A05", "验房工具", "验房工具',
                    iphFn: this.$JsToNative['LOGINACTION'],
                    azFn: this.$JsToNative['CALLANDROIDSHARE']
               };
