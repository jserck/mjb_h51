...
export default {
     data() {
          return {
               ...
               arr: [
                    {
                         img: 'http://app1.homehawkeye.com/one.svg', className: 'qualityOneIndex',
                         title: "地基基础工程",
                    ...
                    {
                         img: 'http://app1.homehawkeye.com/two.svg', className: 'qualityOneIndexTwo',
                         title: "主体结构工程",
                    ...
                    {
                         img: 'http://app1.homehawkeye.com/three.svg', className: 'qualityOneIndexThree',
                         title: "屋面工程",
                         text: "屋面工程施工中",
                         what: "什么是屋面工程？",
                    ...
                    {
                         img: 'http://app1.homehawkeye.com/four.svg', className: 'qualityOneIndexFour',
                         title: "装饰装修工程",
                    ...
                    {
                         img: 'http://app1.homehawkeye.com/five.svg', className: 'qualityOneIndexFive',
                         title: "安装工程",
                         text: "装饰装修工程施工中，施工过程管理较为严格，工程实体质量较好。",
                         what: "什么是安装工程？",
