                    ...
                    <div key="1" v-show="show" v-if="cityMoban == '1'" class="g-mo-sub">
                         <div style="width: 100%;position: relative" @touchmove.prevent>
                              ...
                              <div class="g-mo-sub-img" v-if="repet">
                                   <img src="http://app1.homehawkeye.com/pic_tupian@2x.png" alt="">
                              </div>
                              <div class="g-mo-sub-img" v-else>
                                   <img src="http://app1.homehawkeye.com/pic_yijingyuyuechenggong@2x.png" alt="">
                              </div>
                    ...
                    <div class="g-three-play-ul">
                         <div class="g-three-play-li">
                              <div class="g-three-play-li-img">
                                   <img src="http://app1.homehawkeye.com/icon_xinfangjindu@2x.png" alt="">
                              </div>
                              <span>新房进度</span>
                         ...
                         <div class="g-three-play-li">
                              <div class="g-three-play-li-img">
                                   <img src="http://app1.homehawkeye.com/icon_zhiliangtouming@2x.png" alt="">
                              </div>
                              <span>质量透明</span>
                         ...
                         <div class="g-three-play-li">
                              <div class="g-three-play-li-img">
                                   <img src="http://app1.homehawkeye.com/icon_bikanganhuo@2x.png" alt="">
                              </div>
                              <span>必看干货</span>
                    ...
                    <div class="m-yyjf-what-imgText">
                         ...
                         <div class="m-yyjf-what-imgText-ine">
                              <div class="m-yyjf-what-imgText-ine-img">
                                   <img src="http://app1.homehawkeye.com/pic_vrquanjing@2x.png" alt="">
                              </div>
                         ...
                         <div class="m-yyjf-what-imgText-ine">
                              <div class="m-yyjf-what-imgText-ine-img">
                                   <img src="http://app1.homehawkeye.com/pic_shileishijing@2x.png" alt="">
                              </div>
                         ...
                         <div class="m-yyjf-what-imgText-ine">
                              <div class="m-yyjf-what-imgText-ine-img">
                                   <img src="http://app1.homehawkeye.com/pic_shigongzhiliang@2x.png" alt="">
                              </div>
                         ...
                         <div class="m-yyjf-what-imgText-ine">
                              <div class="m-yyjf-what-imgText-ine-img">
                                   <img src="http://app1.homehawkeye.com/pic_maifang@2x.png" alt="">
                              </div>
                         ...
                         <div class="m-yyjf-what-answers-problem">
                              <div class="m-yyjf-what-answers-problem-li">
                                   <div class="m-yyjf-what-answers-problem-li-img">
                                        <img src="http://app1.homehawkeye.com/pic_konggukailie@2x.png" alt="">
                                   </div>
                                   <p>墙面出现空鼓、开裂</p>
                              </div>
                              <div class="m-yyjf-what-answers-problem-li">
                                   <div class="m-yyjf-what-answers-problem-li-img">
                                        <img src="http://app1.homehawkeye.com/pic_qingxie@2x.png" alt="">
                                   </div>
                                   <p>房屋倾斜、坍塌</p>
                              </div>
                              <div class="m-yyjf-what-answers-problem-li">
                                   <div class="m-yyjf-what-answers-problem-li-img">
                                        <img src="http://app1.homehawkeye.com/pic_qiangmianshenshui@2x.png" alt="">
                                   </div>
                                   <p>墙面渗水、发霉</p>
                              </div>
                              <div class="m-yyjf-what-answers-problem-li">
                                   <div class="m-yyjf-what-answers-problem-li-img">
                                        <img src="http://app1.homehawkeye.com/pic_bugeyin@2x.png" alt="">
                                   </div>
                                   <p>房屋隔音不达标</p>
                              </div>
                         </div>
...
.artifact-bg {
      ...
      overflow: hidden;
      height: 59.88rem;
      background-image: url("http://app1.homehawkeye.com/bg_n%20copy@2x.png");
...
.g-head {
      ...
      width: 100%;
      height: 10.29rem;
      background-image: url("http://app1.homehawkeye.com/pic_toutu@2x.png");
      background-size: cover;
      background-repeat: no-repeat;
}
...
.u-head-logo {
      ...
      width: 1.44rem;
      height: 0.326rem;
      background-image: url("http://app1.homehawkeye.com/pic_logo@2x.png");
      background-size: cover;
      background-repeat: no-repeat;
}
...
.u-head-side {
      ...
      width: 4.21rem;
      height: 0.731rem;
      background-image: url("http://app1.homehawkeye.com/pic_biaotimiaoshu@2x.png");
      background-size: cover;
      background-repeat: no-repeat;
}
...
.g-three-play-tit {
      ...
      width: 4.97rem;
      height: 0.75rem;
      background-image: url("http://app1.homehawkeye.com/pic_one@2x.png");
      background-size: cover;
      background-repeat: no-repeat;
}
...
.g-safeguard-tit {
      ...
      height: 0.819rem;
      margin: auto;
      background-image: url("http://app1.homehawkeye.com/pic_two@2x.png");
      background-size: cover;
      background-repeat: no-repeat;
}
...
.g-safeguard-img {
      ...
      width: 6.7rem;
      height: 2.429rem;
      background-image: url("http://app1.homehawkeye.com/pic_xiangxiangduibi@2x.png");
...
.m-yyjf-what-imgText-tit {
      ...
      background-image: url("http://app1.homehawkeye.com/pic_three@2x.png");
      background-size: cover;
      background-repeat: no-repeat;
}
...
.m-yyjf-what-answers-tit {
      ...
      height: 1.135rem;
      margin: auto;
      background-image: url("http://app1.homehawkeye.com/pic_four@2x.png");
      background-size: cover;
      background-repeat: no-repeat;
}
