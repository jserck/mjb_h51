<template>
     <section class="g-ifream displayFlex flexColumn">
          <section v-show="dialogVisible" @click="dblclickHandler" class="g-moban">
               <section class="g-moban-icon">
                    <img style="width:100%" src="/static/housequery/pic_shuanjipingmu.png" alt />
               </section>
          </section>
          <iframe
               id="iframetest"
          ...
          <footer>
               <section class="g-down displayFlex flexJustifyAround flexAlignItemsCenter">
                    <span class="u-down-logo">
                         <img src="/static/housequery/logo_hengban.png" alt />
                    </span>
...
export default {
     ...
     methods: {
          getHttp() {
               let url = "/buiding/getVRShareDetailInfo";
               let body = {
               ...
               this.$http(options)
                    .then(res => {
                         if (res.response.status === "0") {
                              ...
                              this.ifUrl = this.panoramaData.vrUrl + '&d=' + this.d;
                         }
                    })
                    .catch(err => {
                         // this.set_hint("网络错误");
...
.g-particulars {
     ...
     width: 100%;
     height: 4.55rem;
     background: url("/static/housequery/bg_dibuzhezhao.png") no-repeat;
...
.g-particulars-logo {
     ...
     width: 4.12rem;
     height: 0.55rem;
     background: url("/static/housequery/logo_hengbandaisolgan.png") no-repeat;
     background-size: cover;
}
</style>
<style>
