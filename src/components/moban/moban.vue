     ...
     <div class="moban">
          <div>
               ...
               <div class="moban_" @touchmove.prevent v-if="this.$store.state.school_class">
                    <div
                         :class="['centers',this.$store.state.school_class]"
                         v-if="this.$store.state.motai_num == '0' "
                    >
                         <div class="loadText">
                              <p>{{loadTexts}}</p>
                              <p>更多楼盘质量数据尽在鹰眼鉴房</p>
                              <a @click="loadHref">{{loadHrefs}}</a>
                              <img src="http://app1.homehawkeye.com/pic_download.png?imageslim" />
                              <i
                                   @click="cloce"
                                   class="el-icon-close"
                                   v-if="this.$store.state.is_close"
                              ></i>
                         </div>
                    </div>
                    <div
                         :class="['web_obshare',this.$store.state.school_class]"
                         v-if="this.$store.state.motai_num == '1' "
                    >
                         <img src="/static/fenxiang@3x.png" alt />
                    </div>
                    <div
                         class="click_1"
                         @click="cloce"
                         v-if="this.$store.state.motai_num == '1' || this.$store.state.motai_num == '2'"
                    ></div>
                    <div
                         :class="['survey-centers',this.$store.state.school_class]"
                         v-if="this.$store.state.motai_num == '2' "
                    >
                    ...
                    >
                         <div class="g-suc">
                              <div class="u-suc-tit">
                                   <img src="http://app1.homehawkeye.com/icon_chenggong@3x.png" alt />
                              </div>
                         </div>
                         <div class="g-suc-ine">
                              <p>成功加入鹰眼鉴房</p>
