<template>
     <div class="loginGen">
          ...
          <div class="g-bg">
               <img src="http://app1.homehawkeye.com/bg_n@3x.png" alt>
          </div>
          <div class="g-tit-img">
               <img src="http://app1.homehawkeye.com/vr_yanjing@3x.png" alt>
          </div>
          <div class="g-house-img">
               <img src="http://app1.homehawkeye.com/bg_quanjing@3x.png" alt>
          </div>
          <div class="g-tel-ipu">
               <el-input
                    v-model="phone"
