               ...
               atOnceHome_list: [
                    {
                         ...
                         isAll: false,
                         id: null,
                         src: "http://app1.homehawkeye.com/icon_tongyong_n@3x.png"
                    },
                    {
                         name: "厨房",
                         path: "/testMethod",
                         id: 6,
                         isAll: false,
                         src: "http://app1.homehawkeye.com/icon_chufang_n@3x.png"
                    },
                    {
                         name: "卫生间",
                         path: "/testMethod",
                         id: 7,
                         isAll: false,
                         src: "http://app1.homehawkeye.com/icon_weishengjian_n@3x.png"
                    },
                    {
                         name: "阳台",
                         path: "/testMethod",
                         id: 8,
                         isAll: false,
                         src: "http://app1.homehawkeye.com/icon_yangtai_n@3x.png"
                    },
                    {
                         name: "其他",
                         path: "/testMethod",
                         id: 9,
                         isAll: false,
                         src: "http://app1.homehawkeye.com/icon_qita_n@3x.png"
                    },
                    {
                         name: "五证两书一表",
                         path: "/testMethod",
                         id: 10,
                         isAll: false,
                         src: "http://app1.homehawkeye.com/icon_wuzhengliangshu_n@3x.png"
                    }
               ],
               imgArr: [
                    'http://app1.homehawkeye.com/icon_tongyong_n@3x.png',
                    'http://app1.homehawkeye.com/icon_chufang_n@3x.png',
                    'http://app1.homehawkeye.com/icon_weishengjian_n@3x.png',
                    'http://app1.homehawkeye.com/icon_yangtai_n@3x.png',
                    "http://app1.homehawkeye.com/icon_qita_n@3x.png",
                    "http://app1.homehawkeye.com/icon_wuzhengliangshu_n@3x.png"
               ],
               isBtn: false,
               hintIs: false,
               prvLoad: false,
     ...
     methods: {
          ...
          handler() {
               ...
               this.$http(options).then(response => {
                    ...
                    if (response.code == "0") {
                         let d = JSON.stringify(response.response.data);
