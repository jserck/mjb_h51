<template>
     <div class="testOver">
          ...
          <div class="g-testOver-tit" style="background-image: url('http://app1.homehawkeye.com/bg_yanfangjieguo_l@3x.png')" v-if="stageNum >=40">
          ...
          <div class="g-testOver-tit" style="background-image: url('http://app1.homehawkeye.com/bg_yanfangjieguo_h@3x.png')" v-else>
               <div class="g-stage" v-if="isWater">
                    <WaterWave :stage="stageNum" />
               </div>
               <p class="g-stage-tex">恭喜您获得称号</p>
...
export default {
     ...
     methods: {
          ...
          init() {
               ...
               if (!this.$route.query.isList && !this.$route.query.share) {
...
.g-testOver-tit {
      height: 6.73rem;
      /*background-image: url("http://app1.homehawkeye.com/bg_yanfangjieguo_l@3x.png");*/
